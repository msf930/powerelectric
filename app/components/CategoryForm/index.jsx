    ...
    return (
        <div className={styles.homeFormContOuter}>
            ...
            <div className={styles.homeFormCont}>
                {contactData?.image?.asset?.url && (
                <div className={styles.homeFormContImageContainer}> 
                    <Image src={contactData?.image?.asset?.url} alt="Contact Image" objectFit="cover" fill />
                </div>
                )}
