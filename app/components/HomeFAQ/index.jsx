...
const ITEMS = [
  {
    ...
    a: [
      "Yes.",
      "We offer four membership tiers starting at just $14/ month.",
      "Plans include scheduled maintenance visits, priority scheduling, repair discounts, quarterly filter delivery, and more.",
      "Our Power Protection Plan includes POWERSTAT, an exclusive 24 / 7 smart monitoring system that watches your heating and cooling system around the clock and alerts us when something goes wrong, often before you even notice.",
      "Our Power Heroes Lifetime Membership is completely free for qualifying military members, first responders, and frontline healthcare professionals.",
    ],
  },
  {
    q: "How fast can you come out?",
    a: [
      "We aim to respond the same day for urgent electrical and HVAC issues, particularly situations involving no power, no heat, burning smells, or complete system failure.",
      "For non-emergency work we typically schedule within a few days.",
      "Membership plan members receive priority scheduling and move to the front of the line.",
      "Call us at (720) 272-2562 and we'll give you a realistic arrival estimate.",
    ],
  },
  {
  ...
  },
  {
    ...
    a: [
      "We serve the Denver metro area including Thornton, Brighton, Denver, Northglenn, Westminster, Broomfield, Commerce City, Arvada, Erie, and surrounding communities.",
    ],
    href: "/service-areas",
              ...
              <details key={id} className={styles.item}>
                ...
                <div className={styles.answer}>
                  {item.a.map((paragraph, j) => (
                    <p key={j} className={styles.answerText}>
                      {paragraph}
                    </p>
                  ))}
                  {item?.href && item?.hrefText ? (
